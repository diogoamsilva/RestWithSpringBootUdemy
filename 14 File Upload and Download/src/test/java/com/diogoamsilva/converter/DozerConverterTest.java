...
public class DozerConverterTest {
    ...
    public void parseEntityListToDTOListTest() {
        List<PersonDTO> outputList = DozerConverter.parseObjectList(inputObject.mockEntityList(), PersonDTO.class);
    ...
    public void parserDTOListToEntityListTest() {
        List<Person> outputList = DozerConverter.parseObjectList(inputObject.mockDTOList(), Person.class);
